 ...
 */
final class Version20230521122044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, writed_by_id INT DEFAULT NULL, validated_by_id INT DEFAULT NULL, cover VARCHAR(255) NOT NULL, is_valided TINYINT(1) NOT NULL, publication_date DATETIME NOT NULL, last_modified_date DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_23A0E66E48FD905 (game_id), INDEX IDX_23A0E667B1B5357 (writed_by_id), INDEX IDX_23A0E66C69DE5E5 (validated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, rate INT NOT NULL, publication_date DATETIME NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
